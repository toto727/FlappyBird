...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    // 衝突判定カテゴリー
       ...
       let itemCategory: UInt32 = 1 << 4  //add
       
    // スコア用
        var score = 0
        var itemscore = 0 // add
        var scoreLabelNode:SKLabelNode!
        var itemscoreLabelNode:SKLabelNode! //add
       ...
       func setupWall() {
        ...
        func setupBird() {
            ...
            bird.physicsBody?.contactTestBitMask = groundCategory | wallCategory | itemCategory //add
        ...
        func setupItem(){       //add
            // アイテムの画像を読み込む
            let itemTexture = SKTexture(imageNamed: "bug")
